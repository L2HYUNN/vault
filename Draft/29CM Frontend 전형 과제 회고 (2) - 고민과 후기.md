...
## 고민
과제에 사용할 기술을 모두 선택한 이후에는 **"어떤 방법과 순서로 과제를 풀어나가야 하는가"** 에 대해서 고민하기 시작했다. 요구사항을 따라 바로 개발을 시작하는 방법도 있었겠지만 과제가 아닌 하나의 프로젝트라는 생각으로 어떻게 개발을 진행해야 할지 전체적인 방법을 먼저 고민했다. 

### CDD (Component-Driven Development)

![[cdd-gif.gif]]

가장 먼저 떠올린 방법은 바로 [CDD(Component-Driven Development)](https://www.chromatic.com/blog/component-driven-development/)를 적용하는 것이었다. 이전 프로젝트 부터 컴포넌트를 바텀-업 방식으로 개발하고 있었다. 이러한 바텀 업 개발 방식은 점진적으로 결합(조립)하는 CDD의 성향과 비슷했기 때문에 큰 어려움 없이 개발을 진행할 수 있으며 다음과 같은 이점을 가질 수 있다고 생각했다.
